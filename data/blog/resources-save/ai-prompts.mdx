...
[VibeUI](https://vibeui.online/)<br />
面向 vibe coding 的 UI 布局 prompt 库，当前收录 92 个免费 UI prompts，覆盖 Auth Forms、Pricing、Features / Bento、Hero Sections、CTA Banners、Stats Bars、Nav Bars、Testimonials、Footer、FAQ、Dashboards、Onboarding、Blog / Content、Contact 和 Bonus 等 15 类。适合在 Claude、GPT、Gemini、Cursor、Bolt、v0 这类工具里快速补齐常见页面区块结构，再让模型按截图或产品风格做视觉匹配。
