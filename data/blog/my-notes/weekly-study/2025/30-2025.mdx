...
### [changelog-template](https://github.com/magicuidesign/changelog-template)

使用 Next.js 构建的极简更新日志模板

### [tobiaslins/nextjs-typed-api](https://github.com/tobiaslins/nextjs-typed-api)
...
### [Better Auth 1.3](https://www.better-auth.com/blog/1-3)
