  ...
  return (
    <div className="space-y-2 pt-6 pb-8 md:space-y-5">
      <nav className="flex justify-between">
        ...
        <span>{t('pagination.status', { current: currentPage, total: totalPages })}</span>
        {!nextPage && (
      ...
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
        <div className="space-y-2 pt-6 pb-8 md:space-y-5">
          ...
          <div className="relative max-w-lg">
            <label>
              <span className="sr-only">{t('list.searchArticles')}</span>
              <input
                aria-label={t('list.searchArticles')}
                type="text"
        ...
        <ul>
          {!filteredBlogPosts.length && t('list.noPosts')}
